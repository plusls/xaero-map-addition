...
public class RenderWaypointUtil {
    ...
    public static void drawHighlightWaypointPTC(MatrixStack matrixStack) {
        RenderSystem.bindTexture(Objects.requireNonNull(MinecraftClient.getInstance().getTextureManager().getTexture(PlayerScreenHandler.BLOCK_ATLAS_TEXTURE)).getGlId());
